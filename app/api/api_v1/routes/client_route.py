...
from app.schemas import ClientNewSchema, ClientSchema
from app.service import (client_balance_service, client_info_service,
                         create_client_service, delete_client_service,
                         edit_client_service, list_clients_service)
...
async def edit_client(
    id_client: int, client: ClientNewSchema, db: Session = Depends(get_db)
):
